  ...
  <div class="min-h-screen bg-gray-950">
    ...
    <section id="contact" class="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-gray-800 to-gray-900 relative overflow-hidden">
      ...
      <div class="max-w-3xl mx-auto text-center relative z-10">
        ...
        <div class="mt-10">
          <a href="/register" class="inline-flex items-center gap-2 px-8 py-4 text-base font-semibold text-orange-700 bg-white rounded-xl hover:bg-orange-50 transition shadow-xl">
            {{ l.cta.button }}
            <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" />
            </svg>
