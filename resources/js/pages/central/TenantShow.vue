...
<template>
  <div class="max-w-3xl mx-auto space-y-6">
    <!-- Back -->
    <button @click="router.push('/central/tenants')" class="inline-flex items-center gap-1 text-sm text-orange-700 dark:text-orange-400 hover:text-orange-600">
    ...
    <template v-else-if="tenant">
      ...
      <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
        <div class="flex items-start justify-between">
          ...
          <a
            ...
            target="_blank"
            class="inline-flex items-center gap-1.5 px-3 py-2 text-sm font-medium text-orange-700 dark:text-orange-400 border border-blue-300 rounded-lg hover:bg-orange-50 dark:hover:bg-blue-900/20 transition"
          >
            <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-5">
          <div class="flex items-center justify-between mb-3">
            ...
            <button
              v-if="!editingInfo"
              @click="startEditInfo"
              class="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-orange-700 bg-orange-50 hover:bg-orange-100 dark:bg-orange-900/20 dark:hover:bg-blue-900/40 dark:text-orange-400 rounded-lg transition"
            >
          ...
          <div class="flex items-center justify-between">
            <div class="flex items-center gap-3">
              <div class="w-10 h-10 rounded-lg flex items-center justify-center" :class="tenant.pos_enabled ? 'bg-orange-100 dark:bg-orange-900/30' : 'bg-gray-100 dark:bg-gray-700'">
                <svg :class="['w-5 h-5', tenant.pos_enabled ? 'text-orange-600 dark:text-orange-400' : 'text-gray-400']" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            ...
            <div class="space-y-2">
              <label class="flex items-center gap-2 cursor-pointer">
                ...
                <span class="text-sm text-gray-700 dark:text-gray-300">
                  <svg class="w-4 h-4 inline text-orange-600 dark:text-orange-400 mr-1" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
      ...
      <div class="bg-white dark:bg-gray-800 rounded-xl border border-orange-200 dark:border-blue-900/50 p-5">
        <div class="flex items-center gap-2 mb-4">
          ...
          <h3 class="text-sm font-semibold text-orange-700 dark:text-orange-400">Importer des produits depuis un site e-commerce</h3>
        </div>
        ...
        <div v-if="scrapedProducts.length > 0" class="mt-4 space-y-3">
          <div class="flex items-center justify-between">
            <div class="flex items-center gap-3">
              ...
              <label class="flex items-center gap-1.5 cursor-pointer text-xs text-orange-700 dark:text-orange-400">
                <input type="checkbox" :checked="selectedProducts.size === scrapedProducts.length" @change="toggleAllProducts" class="w-3.5 h-3.5 text-orange-600 dark:text-orange-400 rounded" />
                Tout sélectionner
              </label>
            </div>
        ...
        <div class="space-y-4">
          ...
          <label class="flex items-center gap-2 cursor-pointer">
            <input
              ...
              type="checkbox"
              class="w-4 h-4 text-orange-600 dark:text-orange-400 bg-gray-100 border-gray-300 rounded focus:ring-orange-500"
            />
            <span class="text-sm text-gray-700 dark:text-gray-300">
