  ...
  <div class="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800 flex items-center justify-center px-4">
    <div class="max-w-lg w-full bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 p-8 text-center">
      <div class="w-16 h-16 mx-auto mb-5 rounded-full bg-orange-100 dark:bg-orange-900/30 flex items-center justify-center">
        <svg class="w-8 h-8 text-orange-500 dark:text-orange-400" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
      ...
      <p class="text-sm text-gray-600 dark:text-gray-400 mb-6">
        ...
        <span v-if="domain" class="font-mono text-orange-500 dark:text-orange-400">{{ domain }}</span>.
      </p>

      <div class="bg-orange-50 dark:bg-orange-900/20 rounded-xl p-4 text-left text-sm text-blue-900 dark:text-blue-200 mb-6">
        <p class="font-semibold mb-1">⏱️ Le lien est valide 24 heures</p>
        <p class="text-orange-600/80 dark:text-orange-300/80">
