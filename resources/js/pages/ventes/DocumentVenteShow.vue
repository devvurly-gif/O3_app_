  ...
  <div class="max-w-9xl mx-auto py-4 sm:py-6 px-3 sm:px-4">
    ...
    <BaseModal v-model="showInvoiceModal" title="Générer la Facture" size="sm">
      <div class="space-y-4">
        ...
        <div>
          <label for="documentventeshow-invoicepaymentmethod" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Moyen de paiement *</label>
          <select
    ...
    <CustomerDetailModalFull v-model="showCustomerDetailModal" :customer="selectedCustomer" :customerId="selectedCustomerId" type="customer" />
  </div>
</template>
