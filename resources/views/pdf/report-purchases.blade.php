...
<div class="page">
    ...
    <div class="header">
        ...
        <div class="header-right">
            <div class="doc-title">Rapport des Achats</div>
    ...
    <div class="cards">
        <div class="card">
            <div class="card-inner">
                <div class="card-label">Total Achats TTC</div>
                <div class="card-value">{{ number_format($data['totals']['spending_ttc'], 2, ',', ' ') }}</div>
            </div>
        </div>
        <div class="card">
            <div class="card-inner">
                <div class="card-label">Total Achats HT</div>
                <div class="card-value">{{ number_format($data['totals']['spending_ht'], 2, ',', ' ') }}</div>
            </div>
        </div>
        <div class="card">
            <div class="card-inner">
    ...
    <div class="section-title">Top 10 Produits Achetés</div>
    <table class="data">
        <thead>
            <tr>
                <th style="width: 50%">Produit</th>
                <th class="right">Qté achetée</th>
                <th class="right">Coût TTC</th>
            </tr>
        </thead>
        <tbody>
    ...
    <table class="data">
        ...
        <tbody>
            @foreach($data['top_suppliers'] as $row)
            <tr>
                <td>{{ $row['tp_title'] }}</td>
    ...
    @if(count($data['daily_spending']) > 0)
    ...
    <table class="data">
        ...
        <tbody>
            @foreach($data['daily_spending'] as $row)
            <tr>
